...
class Input extends Component {
    ...
    onChangeType = () =>
        this.setState({
            visibilityType:
                this.state.visibilityType === INPUT_TYPE.PASSWORD
                    ? INPUT_TYPE.TEXT
                    : INPUT_TYPE.PASSWORD,
        })
...
const InputElement = styled.input`
  ...
  &:-webkit-autofill:active {
    ...
    -webkit-box-shadow: 0 0 0 1000px ${props => props.theme.colors.white} inset !important;
    -webkit-text-fill-color: ${props => props.theme.colors.gray500} !important;
  }
`
